////////////////////////////////////////////////////////////////////////////////
// npcact_wrapa - OnRest Wrapper (works for NPC ACTIVITIES and RTSA
//==============================================================================
// By Deva Bryson Winblood.   NPC ACTIVITIES 6.0 & RTSA 2.0
////////////////////////////////////////////////////////////////////////////////
// sCRSPRested - NPC ACTIVITIES Custom Script
// sRTSA_wrapa  - RTSA Custom Script
...
void main()
{
     ...
     string sCRSP=GetLocalString(oMe,"sCRSPRested");
     string sRTSA=GetLocalString(oMe,"sRTSA_wrapa");
     int nMode=GetLocalInt(oMe,"nWrap_Mode");
     int nGNB=GetLocalInt(oMe,"nGNBCloseMode");
     string sWPName="POST_"+GetTag(oMe);
     string sDefault="nw_c2_defaulta";
     string sNPC_SCRIPT="nw_c2_defaulta"; // npc activities
     string sRTSA_SCRIPT="x2_def_rested"; // RTSA script
     string sX2Default="x2_def_rested";
     string sEarlyHench="nw_ch_aca";
     string sNewHench="npcact_hencha";
     string sJASP="j_ai_ononrest";
     string sCODI="no_ai_rst";
