        ...
        if   (no_pocet_cyklu >= 10) {
            ...
            SetLocalInt(OBJECT_SELF,"no_nasada",0);
                ...
                SetLocalInt(OBJECT_SELF,"no_disturbklikacu",GetLocalInt(OBJECT_SELF,"no_disturbklikacu")+1);
                 ...
                 switch ( d4(1) )  {
                            case 1: { AssignCommand(no_oPC,SpeakString("Kde sem to jen dal..",TALKVOLUME_WHISPER));
                            break;    }
                            case 2: { AssignCommand(no_oPC,SpeakString("Jaj, upadl mi ingot..",TALKVOLUME_WHISPER));
                            break;    }
                            case 3: { AssignCommand(no_oPC,SpeakString("Kde jen sem dal nasadu..",TALKVOLUME_WHISPER));
                            break;    }
                            case 4: { AssignCommand(no_oPC,SpeakString("Jauvajs. klepl jsem se do ruky..",TALKVOLUME_WHISPER));
                            break;    }
                            }//konec switche
