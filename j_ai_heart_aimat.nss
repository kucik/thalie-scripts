...
//        PlayMobileAmbientAnimations_NonAvian();
        ActionRandomWalk();
//        SendMessageToPC(GetFirstPC(),GetName(OBJECT_SELF)+"performs: PlayMobileAmbientAnimations_NonAvian ");
    }
    else if(GetSpawnInCondition(NW_FLAG_AMBIENT_ANIMATIONS_AVIAN))
    {
//        PlayMobileAmbientAnimations_Avian();
        ActionRandomWalk();
//        SendMessageToPC(GetFirstPC(),GetName(OBJECT_SELF)+"performs: PlayMobileAmbientAnimations_Avian ");
    }
    else if(GetSpawnInCondition(NW_FLAG_IMMOBILE_AMBIENT_ANIMATIONS))
    {
        PlayImmobileAmbientAnimations();
//        SendMessageToPC(GetFirstPC(),GetName(OBJECT_SELF)+"performs: PlayImmobileAmbientAnimations ");
    }
    else
    {
