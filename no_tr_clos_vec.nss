            ...
            SetLocalString(OBJECT_SELF,"no_vyrobek","");
                ...
                SetLocalInt(OBJECT_SELF,"no_disturbklikacu",GetLocalInt(OBJECT_SELF,"no_disturbklikacu")+1);
                 ...
                 switch ( d4(1) )  {
                            ...
                            break;    }
                            case 3: { AssignCommand(no_oPC,SpeakString("Ten plech tay nekde musi byt..",TALKVOLUME_WHISPER));
                            break;    }
                            case 4: { AssignCommand(no_oPC,SpeakString("Nemel bych jit sehnat nove nyty ?..",TALKVOLUME_WHISPER));
                            break;    }
                            }//konec switche
