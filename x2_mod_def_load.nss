...
void __InitWeaponsFeats() {
  ...
  SetWeaponFocusFeat(305,1123);// Falchion
  ...
  SetWeaponImprovedCriticalFeat(305,1142);// Falchion
  ...
  SetWeaponSpecializationFeat(305,1161);// Falchion
  ...
  SetWeaponOfChoiceFeat(305,1180);// Falchion
  ...
  SetWeaponOverwhelmingCriticalFeat(305,1199);// Falchion
  ...
  SetWeaponDevastatingCriticalFeat(305,1218);// Falchion
  ...
  SetWeaponEpicFocusFeat(305,1237);// Falchion
  ...
  SetWeaponEpicSpecializationFeat(305,1256);// Falchion
