////////////////////////////////////////////////////////////////////////////////
// npcact_wrap7 - OnDeath Wrapper (works for NPC ACTIVITIES and RTSA
//==============================================================================
// By Deva Bryson Winblood.   NPC ACTIVITIES 6.0 & RTSA 2.0
////////////////////////////////////////////////////////////////////////////////
// sCRSPDeath - NPC ACTIVITIES Custom Script
// sRTSA_wrap7  - RTSA Custom Script
...
void main()
{
     ...
     string sCRSP=GetLocalString(oMe,"sCRSPDeath");
     string sRTSA=GetLocalString(oMe,"sRTSA_wrap7");
     int nMode=GetLocalInt(oMe,"nWrap_Mode");
     int nGNB=GetLocalInt(oMe,"nGNBCloseMode");
     string sWPName="POST_"+GetTag(oMe);
     string sDefault="nw_c2_default7";
     string sNPC_SCRIPT="nw_c2_default7"; // npc activities
     string sRTSA_SCRIPT="x2_def_ondeath"; // RTSA script
     string sX2Default="x2_def_ondeath";
     string sEarlyHench="nw_ch_ac7";
     string sNewHench="npcact_hench7";
     string sJASP="j_ai_ondeath";
     string sCODI="no_ai_dth";
