...
// End of Spell Cast Hook
    ...
    effect eAOE = EffectAreaOfEffect(AOE_PER_FOGMIND,"sp_mindfoga","****","sp_mindfogb");
    location lTarget = GetSpellTargetLocation();
    int nDuration = 2 + GetThalieCaster(OBJECT_SELF,OBJECT_SELF,GetCasterLevel(OBJECT_SELF),FALSE) / 2;
