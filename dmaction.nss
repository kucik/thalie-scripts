...
void main() {
    ...
    switch(nAction) {
      case DM_ACTION_GIVE_XP:
        LogDMAction(oDM, oGetDMAction_Target(), "GIVE_XP",nGetDMAction_Param());
        break;
      case DM_ACTION_GIVE_LEVEL:
        LogDMAction(oDM, oGetDMAction_Target(), "GIVE_LEVEL",nGetDMAction_Param());
        break;
      case DM_ACTION_GIVE_GOLD:
        LogDMAction(oDM, oGetDMAction_Target(), "GIVE_GOLD",nGetDMAction_Param());
        break;
      case DM_ACTION_HEAL_CREATURE:
        LogDMAction(oDM, oGetDMAction_Target(), "HEAL",1);
        break;
    }
