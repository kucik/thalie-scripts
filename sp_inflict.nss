...
// End of Spell Cast Hook
    ...
    if (GetHasFeat(FEAT_DESTRUCTION_DOMAIN_POWER))   // ma domenu niceni
    {

        switch (nSpellID)
        {
            /*Minor*/     case 431: spellsInflictTouchAttack(2, 0, 2, 246, VFX_IMP_HEALING_G, nSpellID); break;
            /*Light*/     case 432: case 609: spellsInflictTouchAttack(d12(), 5, 12, 246, VFX_IMP_HEALING_G, nSpellID); break;
            /*Moderate*/  case 433: case 610: spellsInflictTouchAttack(d12(2), 10, 24, 246, VFX_IMP_HEALING_G, nSpellID); break;
            /*Serious*/   case 434: case 611: spellsInflictTouchAttack(d12(3), 15, 32, 246, VFX_IMP_HEALING_G, nSpellID); break;
            /*Critical*/  case 435: case 612: spellsInflictTouchAttack(d12(4), 20, 48, 246, VFX_IMP_HEALING_G, nSpellID); break;
        }
    }
    else   // nema domenu niceni
    {
