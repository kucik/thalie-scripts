////////////////////////////////////////////////////////////////////////////////
// npcact_wrapb - OnSpellCastAt Wrapper (works for NPC ACTIVITIES and RTSA
//==============================================================================
// By Deva Bryson Winblood.   NPC ACTIVITIES 6.0 & RTSA 2.0
////////////////////////////////////////////////////////////////////////////////
// sCRSPSCA - NPC ACTIVITIES Custom Script
// sRTSA_wrapb  - RTSA Custom Script
...
void main()
{
     ...
     string sCRSP=GetLocalString(oMe,"sCRSPSCA");
     string sRTSA=GetLocalString(oMe,"sRTSA_wrapb");
     int nMode=GetLocalInt(oMe,"nWrap_Mode");
     int nGNB=GetLocalInt(oMe,"nGNBCloseMode");
     string sWPName="POST_"+GetTag(oMe);
     string sDefault="nw_c2_defaultb";
     string sNPC_SCRIPT="nw_c2_defaultb"; // npc activities
     string sRTSA_SCRIPT="x2_def_spellcast"; // RTSA script
     string sX2Default="x2_def_spellcast";
     string sEarlyHench="nw_ch_acb";
     string sNewHench="npcact_henchb";
     string sJASP="j_ai_onspellcast";
     string sCODI="no_ai_spt";
