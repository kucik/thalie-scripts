...
// End of Spell Cast Hook
    ...
    float fDelay;
    int nResist;
    int mainAbility = GetAbilityModifier(ABILITY_INTELLIGENCE);
    if (GetAbilityModifier(ABILITY_CHARISMA)>mainAbility)  mainAbility = GetAbilityModifier(ABILITY_CHARISMA);
