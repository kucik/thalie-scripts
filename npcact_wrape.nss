////////////////////////////////////////////////////////////////////////////////
// npcact_wrape - OnBlocked Wrapper (works for NPC ACTIVITIES and RTSA
//==============================================================================
// By Deva Bryson Winblood.   NPC ACTIVITIES 6.0 & RTSA 2.0
////////////////////////////////////////////////////////////////////////////////
// sCRSPBlocked - NPC ACTIVITIES Custom Script
// sRTSA_wrape  - RTSA Custom Script
...
void main()
{
     ...
     string sCRSP=GetLocalString(oMe,"sCRSPBlocked");
     string sRTSA=GetLocalString(oMe,"sRTSA_wrape");
     int nMode=GetLocalInt(oMe,"nWrap_Mode");
     int nGNB=GetLocalInt(oMe,"nGNBCloseMode");
     string sWPName="POST_"+GetTag(oMe);
     string sDefault="nw_c2_defaulte";
     string sNPC_SCRIPT="npcact_scripte"; // npc activities
     string sRTSA_SCRIPT="x2_def_onblocked"; // RTSA script
     string sX2Default="x2_def_onblocked";
     string sEarlyHench="nw_ch_ace";
     string sNewHench="npcact_henche";
     string sJASP="j_ai_onblocked";
     string sCODI="no_ai_blk";
