...
int jy_kritik; //sËÌtav· kritick˝ bonus k dmg, aby vÔaka nemu na konci vyhodnotil, ak˝ presne pridaù ako vlastnosù predmetu
...
//˙prava by Jachyra: nikdy sa neurobÌ vylepöenie vyööie ako povoæuje samotn˝ no_kov_1
switch ( GetLocalInt(OBJECT_SELF,"no_kov_1")) {
case 1: {   if ( no_bonus_vylepseni >0 ){
              no_bonus_vylepseni = 0;
...
case 12: {   if ( no_bonus_vylepseni >5 ){
              ...
              FloatingTextStringOnCreature(" Safra, pro lepsi vysledek budu potrebovat lepsi primarni kov",no_oPC,FALSE );   }
            break;}
} //koniec ˙prava by Jachyra


//˙prava by Jachyra: pri prid·vanÌ vlastnostÌ napoËÌtalo kritik a teraz ho vyhodnotÌ a podæa toho prid·
