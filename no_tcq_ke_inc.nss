...
const string resref_tenka_forma = "tc_form_tenk";
const string resref_sklenena_ampule = "tc_alch_potion2";
const string resref_stredni_forma = "cnrmoldmedium";
const string resref_velka_forma = "cnrmoldlarge";
const string resref_zahnuta_forma = "tc_form_zahn";
