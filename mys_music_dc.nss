...
int StartingConditional()
{
    ...
    else if (sText == "1:26 Váka")
    {
        return MusicGetMusicianPerformRank(oPC, 35);
    }
    else if (sText == "1:26 Širı kraj")
    {
    ...
    else if (sText == "1:12 Pastıøskı tanec")
    {
        return MusicGetMusicianPerformRank(oPC, 35);
    }
    else if (sText == "1:16 Dvorskı tanec")
    {
        return MusicGetMusicianPerformRank(oPC, 35);
    }
    else if (sText == "2:11 Spi, mùj milı, spi")
    {
        return MusicGetMusicianPerformRank(oPC, 40);
    }
    else if (sText == "4:02 Ivorskı kozeleèek")
    {
        return MusicGetMusicianPerformRank(oPC, 40);
    }
    ...
    else if (sText == "0:51 Vojenskı pochod 1")
    {
        return MusicGetMusicianPerformRank(oPC, 15);
    }
    ...
    else if (sText == "1:15 Vojenskı pochod 2")
    {
        return MusicGetMusicianPerformRank(oPC, 25);
    }
    ...
    else if (sText == "Thalie - Vıhra 01")
    {
        return MusicGetMusicianPerformRank(oPC, 120);
    }
    else if (sText == "Thalie - Vıhra 02")
    {
        return MusicGetMusicianPerformRank(oPC, 120);
    }
