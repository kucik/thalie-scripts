...
string NWNX_LocationToString(location lLocation);
...
string NWNX_VectorToString(vector vVector);
...
void SetPersistentLocation(object oObject, string sVarName, location lLocation, int iExpiration=0, string sTable="pwdata")
{
    SetPersistentString(oObject, sVarName, NWNX_LocationToString(lLocation), iExpiration, sTable);
}
...
void SetPersistentVector(object oObject, string sVarName, vector vVector, int iExpiration=0, string sTable ="pwdata")
{
    SetPersistentString(oObject, sVarName, NWNX_VectorToString(vVector), iExpiration, sTable);
}
