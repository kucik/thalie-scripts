////////////////////////////////////////////////////////////////////////////////
// npcact_wrapd - OnUserDefined Wrapper (works for NPC ACTIVITIES and RTSA
//==============================================================================
// By Deva Bryson Winblood.   NPC ACTIVITIES 6.0 & RTSA 2.0
////////////////////////////////////////////////////////////////////////////////
// sCRSPUser - NPC ACTIVITIES Custom Script
// sRTSA_wrapd  - RTSA Custom Script
...
void main()
{
     ...
     string sCRSP=GetLocalString(oMe,"sCRSPUser");
     string sRTSA=GetLocalString(oMe,"sRTSA_wrapd");
     int nMode=GetLocalInt(oMe,"nWrap_Mode");
     int nGNB=GetLocalInt(oMe,"nGNBCloseMode");
     string sWPName="POST_"+GetTag(oMe);
     string sDefault="nw_c2_defaultd";
     string sNPC_SCRIPT="npcact_scriptd"; // npc activities
     string sRTSA_SCRIPT="x2_def_userdef"; // RTSA script
     string sX2Default="x2_def_userdef";
     string sEarlyHench="nw_ch_acd";
     string sNewHench="npcact_henchd";
     string sJASP="j_ai_onuserdef";
     string sCODI="x2_def_userdef";
