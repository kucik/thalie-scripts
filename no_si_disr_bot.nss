...
//12 - vyroba chranice      tag: no_vyr_chra
...
if (GetTag(no_vzataItem) == "no_vyr_boty" ) {
...
if (GetTag(no_vzataItem) == "no_vyr_ruka" ) {
no_znicit(OBJECT_SELF); //znicime vsechny prepinace
no_znicit(no_oPC);
no_reopen(no_oPC);
...
//0  - Zpet do menu       tag: no_zpet
/////////////////////////////2-NASTAVIT vyroba drevcovych zbrani/////////////////////////////////
if (GetTag(no_vzataItem) == "no_vyr_opas" ) {
no_znicit(OBJECT_SELF); //znicime vsechny prepinace
no_znicit(no_oPC);
no_reopen(no_oPC);
...
/////////////////////////////2-NASTAVIT vyroba drevcovych zbrani/////////////////////////////////
if (GetTag(no_vzataItem) == "no_vyr_plas" ) {
no_znicit(OBJECT_SELF); //znicime vsechny prepinace
no_znicit(no_oPC);
no_reopen(no_oPC);
...
/////////////////////////////2-NASTAVIT vyroba drevcovych zbrani/////////////////////////////////
if (GetTag(no_vzataItem) == "no_vyr_saty" ) {
no_znicit(OBJECT_SELF); //znicime vsechny prepinace
no_znicit(no_oPC);
no_reopen(no_oPC);
FloatingTextStringOnCreature("Vyroba tvrzene roby",no_oPC,FALSE );
DelayCommand(0.1,SetName(CreateItemOnObject("prepinac003",OBJECT_SELF,1,"no_zpet"),"Zpet"));
SetLocalInt(OBJECT_SELF,"no_menu",5);
} //////////////////////////////////////////////
/////////////////////////////2-NASTAVIT vyroba drevcovych zbrani/////////////////////////////////
if (GetTag(no_vzataItem) == "no_vyr_vyzt" ) {
no_znicit(OBJECT_SELF); //znicime vsechny prepinace
no_znicit(no_oPC);
no_reopen(no_oPC);
...
/////////////////////////////2-NASTAVIT vyroba drevcovych zbrani/////////////////////////////////
if (GetTag(no_vzataItem) == "no_vyr_koze" ) {
no_znicit(OBJECT_SELF); //znicime vsechny prepinace
no_znicit(no_oPC);
no_reopen(no_oPC);
FloatingTextStringOnCreature("Vyroba kozenych zbroji",no_oPC,FALSE );
DelayCommand(0.1,SetName(CreateItemOnObject("prepinac003",OBJECT_SELF,1,"no_zpet"),"Zpet"));
SetLocalInt(OBJECT_SELF,"no_menu",7);
} //////////////////////////////////////////////

/////////////////////////////2-NASTAVIT vyroba drevcovych zbrani/////////////////////////////////
if (GetTag(no_vzataItem) == "no_vyr_tvrz" ) {
no_znicit(OBJECT_SELF); //znicime vsechny prepinace
no_znicit(no_oPC);
no_reopen(no_oPC);
FloatingTextStringOnCreature("Vyroba pokovnaych kozenych zbroji",no_oPC,FALSE );
DelayCommand(0.1,SetName(CreateItemOnObject("prepinac003",OBJECT_SELF,1,"no_zpet"),"Zpet"));
...
//11 - vyroba kape          tag: no_vyr_kape
/////////////////////////////2-NASTAVIT vyroba drevcovych zbrani/////////////////////////////////
if (GetTag(no_vzataItem) == "no_vyr_kape" ) {
no_znicit(OBJECT_SELF); //znicime vsechny prepinace
no_znicit(no_oPC);
no_reopen(no_oPC);
...
//12 - vyroba chranice      tag: no_vyr_chra
/////////////////////////////2-NASTAVIT vyroba drevcovych zbrani/////////////////////////////////
if (GetTag(no_vzataItem) == "no_vyr_chra" ) {
no_znicit(OBJECT_SELF); //znicime vsechny prepinace
no_znicit(no_oPC);
no_reopen(no_oPC);
FloatingTextStringOnCreature("Vyroba chranicu",no_oPC,FALSE );
DelayCommand(0.1,SetName(CreateItemOnObject("prepinac003",OBJECT_SELF,1,"no_zpet"),"Zpet"));
...
DelayCommand(0.1,SetName(CreateItemOnObject("prepinac001",OBJECT_SELF,1,"no_vyr_ruka"),"Vyroba rukavic"));
...
DelayCommand(0.1,SetName(CreateItemOnObject("prepinac001",OBJECT_SELF,1,"no_vyr_saty"),"Vyroba vyztuzene roby"));
...
DelayCommand(0.1,SetName(CreateItemOnObject("prepinac001",OBJECT_SELF,1,"no_vyr_chra"),"Vyroba chranicu"));
