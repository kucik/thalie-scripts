...
int CNR_TRADESKILL_INFUSING = 12;
...
float CNR_FLOAT_ORE_MINING_DEPOSIT_BREAKAGE_PERCENTAGE = 2.0;
...
float CNR_FLOAT_GEM_MINING_DEPOSIT_BREAKAGE_PERCENTAGE = 2.0;
...
float CNR_FLOAT_WOOD_MINING_TREE_BREAKAGE_PERCENTAGE = 2.0;
