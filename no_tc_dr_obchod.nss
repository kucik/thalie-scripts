...
// Buï otevøi obchod s tímto tagem, nebo uživateli oznam, že žádný obchod neexistuje.
    ...
    object oStore = GetObjectByTag("no_tcob_dr_" + GetLocalString(OBJECT_SELF,"no_obchod"));
...
oStore = CreateObject(OBJECT_TYPE_STORE,"no_tcob_dr_kara",no_lokace,FALSE,("no_tcob_dr_" + GetLocalString(OBJECT_SELF,"no_obchod")));
        OpenStore(oStore,GetPCSpeaker());
...
if   (GetTag(no_Item)=="tc_moridlo_pra" )  DestroyObject(no_Item);
if   (GetTag(no_Item)=="tc_moridlo_zel" )  DestroyObject(no_Item);
if   (GetTag(no_Item)=="tc_moridlo_jil" )  DestroyObject(no_Item);
...
if   (GetTag(no_Item)=="tc_moridlo_zel" )  DestroyObject(no_Item);
if   (GetTag(no_Item)=="tc_moridlo_jil" )  DestroyObject(no_Item);
if   (GetTag(no_Item)=="tc_moridlo_tis" )  DestroyObject(no_Item);
if   (GetTag(no_Item)=="tc_moridlo_mah" )  DestroyObject(no_Item);
if   (GetTag(no_Item)=="tc_moridlo_dub" )  DestroyObject(no_Item);
