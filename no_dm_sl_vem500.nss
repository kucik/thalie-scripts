...
int no_level =  TC_getLevel(no_oPC,20);
    ...
    SendMessageToPC(no_oPC ,"Odebrano 500 craftovych xp ve slevarenstvi");
...
SetCustomToken(9026, "Slevarina:" + IntToString(no_xpy -500) + " xp = " + IntToString(no_level) + ". lvl");

SetPersistentInt(no_oPC,"tcXPSystem" + IntToString(20),no_xpy - 500,0);
