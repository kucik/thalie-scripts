...
/*
    SpeakString("Received event "+IntToString(nEvent));
    SendMessageToPC(GetFirstPC(),"Received event "+IntToString(nEvent));
    WriteTimestampedLogEntry("Received event "+IntToString(nEvent));
*/
