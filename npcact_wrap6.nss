////////////////////////////////////////////////////////////////////////////////
// npcact_wrap6 - OnDamaged Wrapper (works for NPC ACTIVITIES and RTSA
//==============================================================================
// By Deva Bryson Winblood.   NPC ACTIVITIES 6.0 & RTSA 2.0
////////////////////////////////////////////////////////////////////////////////
// sCRSPDamaged - NPC ACTIVITIES Custom Script
// sRTSA_wrap6  - RTSA Custom Script
...
void main()
{
     ...
     string sCRSP=GetLocalString(oMe,"sCRSPDamaged");
     string sRTSA=GetLocalString(oMe,"sRTSA_wrap6");
     int nMode=GetLocalInt(oMe,"nWrap_Mode");
     int nGNB=GetLocalInt(oMe,"nGNBCloseMode");
     string sWPName="POST_"+GetTag(oMe);
     string sDefault="nw_c2_default6";
     string sNPC_SCRIPT="nw_c2_default6"; // npc activities
     string sRTSA_SCRIPT="x2_def_ondamage"; // RTSA script
     string sX2Default="x2_def_ondamage";
     string sEarlyHench="nw_ch_ac6";
     string sNewHench="npcact_hench6";
     string sJASP="j_ai_ondamaged";
     string sCODI="no_ai_dam";
