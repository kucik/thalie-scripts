...
void main()
{
    ...
    object oDvere = GetObjectByTag ("rych_zach1");

    if (nIsOpen == 0)   //if the item is a door
    {
        object oSelf = OBJECT_SELF;
        PlayAnimation(ANIMATION_PLACEABLE_OPEN);
        AssignCommand (oDvere,PlayAnimation(ANIMATION_PLACEABLE_OPEN));
        DelayCommand (0.5, UseSecretTransport(GetLastUsedBy()));
    ...
    else
    {
        ...
        AssignCommand (oDvere,PlayAnimation(ANIMATION_PLACEABLE_CLOSE));
