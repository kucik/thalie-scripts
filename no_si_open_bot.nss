...
//12 - vyroba chrnice       tag: no_vyr_chra
DelayCommand(0.1,SetName(CreateItemOnObject("prepinac001",OBJECT_SELF,1,"no_vyr_chra"),"Vyroba chranice"));
...
DelayCommand(0.1,SetName(CreateItemOnObject("prepinac002",OBJECT_SELF,1,"no_men_mater"),"Volba materialu pro vyrobu"));
 ...
 FloatingTextStringOnCreature("Vyroba botu",no_oPC,FALSE );
   ...
   if(no_menu == 2)
   {
 FloatingTextStringOnCreature("Vyroba rukavic",no_oPC,FALSE );
 }
  else
   if(no_menu == 3)
   {
 ...
 FloatingTextStringOnCreature("Vyroba kapuce",no_oPC,FALSE );
   ...
   if(no_menu == 12)
   {
 FloatingTextStringOnCreature("Vyroba chranice",no_oPC,FALSE );
}
 else
