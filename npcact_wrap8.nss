////////////////////////////////////////////////////////////////////////////////
// npcact_wrap8 - OnDisturbed Wrapper (works for NPC ACTIVITIES and RTSA
//==============================================================================
// By Deva Bryson Winblood.   NPC ACTIVITIES 6.0 & RTSA 2.0
////////////////////////////////////////////////////////////////////////////////
// sCRSPDisturbed - NPC ACTIVITIES Custom Script
// sRTSA_wrap8  - RTSA Custom Script
...
void main()
{
     ...
     string sCRSP=GetLocalString(oMe,"sCRSPDisturbed");
     string sRTSA=GetLocalString(oMe,"sRTSA_wrap8");
     int nMode=GetLocalInt(oMe,"nWrap_Mode");
     int nGNB=GetLocalInt(oMe,"nGNBCloseMode");
     string sWPName="POST_"+GetTag(oMe);
     string sDefault="nw_c2_default8";
     string sNPC_SCRIPT="nw_c2_default8"; // npc activities
     string sRTSA_SCRIPT="x2_def_ondisturb"; // RTSA script
     string sX2Default="x2_def_ondisturb";
     string sEarlyHench="nw_ch_ac8";
     string sNewHench="npcact_hench8";
     string sJASP="j_ai_ondistrubed";
     string sCODI="no_ai_dis";
