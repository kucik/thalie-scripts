...
void main()
{
    ...
    switch (iUnivInt)
    {
        case 50: eI= EffectDamage(d4(iDMSetNumber), DAMAGE_TYPE_MAGICAL, DAMAGE_POWER_PLUS_TWENTY);
        ...
        case 51: eI = EffectDamage(d6(iDMSetNumber), DAMAGE_TYPE_MAGICAL, DAMAGE_POWER_PLUS_TWENTY);
                 eVis = EffectVisualEffect(VFX_COM_BLOOD_LRG_RED);
                 ApplyEffectToObject(DURATION_TYPE_INSTANT, eI, oTarget);
                 ApplyEffectToObject(DURATION_TYPE_PERMANENT, eVis, oTarget);break;
        case 52: eI = EffectDamage(d8(iDMSetNumber), DAMAGE_TYPE_MAGICAL, DAMAGE_POWER_PLUS_TWENTY);
                 eVis = EffectVisualEffect(VFX_COM_BLOOD_LRG_RED);
                 ApplyEffectToObject(DURATION_TYPE_INSTANT, eI, oTarget);
                 ApplyEffectToObject(DURATION_TYPE_PERMANENT, eVis, oTarget);break;
        case 53: eI = EffectDamage(d10(iDMSetNumber), DAMAGE_TYPE_MAGICAL, DAMAGE_POWER_PLUS_TWENTY);
                 eVis = EffectVisualEffect(VFX_COM_BLOOD_SPARK_SMALL);
                 ApplyEffectToObject(DURATION_TYPE_INSTANT, eI, oTarget);
                 ApplyEffectToObject(DURATION_TYPE_PERMANENT, eVis, oTarget);break;
        case 54: eI = EffectDamage(d12(iDMSetNumber), DAMAGE_TYPE_MAGICAL, DAMAGE_POWER_PLUS_TWENTY);
                 eVis = EffectVisualEffect(VFX_COM_BLOOD_SPARK_SMALL);
                 ApplyEffectToObject(DURATION_TYPE_INSTANT, eI, oTarget);
                 ApplyEffectToObject(DURATION_TYPE_PERMANENT, eVis, oTarget);break;
        case 55: eI = EffectDamage(FloatToInt(IntToFloat(iDMSetNumber)/100*GetCurrentHitPoints(oTarget)), DAMAGE_TYPE_MAGICAL, DAMAGE_POWER_PLUS_TWENTY);
                 eVis = EffectVisualEffect(VFX_COM_BLOOD_LRG_RED);
                 ApplyEffectToObject(DURATION_TYPE_INSTANT, eI, oTarget);
                 ApplyEffectToObject(DURATION_TYPE_PERMANENT, eVis, oTarget);break;
        case 56: eI = EffectDamage(GetCurrentHitPoints(oTarget)-1, DAMAGE_TYPE_MAGICAL, DAMAGE_POWER_PLUS_TWENTY);
                 eVis =EffectVisualEffect(VFX_COM_CHUNK_RED_SMALL);
                 ApplyEffectToObject(DURATION_TYPE_INSTANT, eI, oTarget);
                 ApplyEffectToObject(DURATION_TYPE_PERMANENT, eVis, oTarget);break;
         case 10: eT = EffectPetrify(); ApplyEffectToObject(DURATION_TYPE_TEMPORARY, eT, oTarget, fDuration); break;
        case 11: eT = EffectBlindness(); ApplyEffectToObject(DURATION_TYPE_TEMPORARY, eT, oTarget, fDuration);break;
        case 12: eT = EffectCurse(4,4,4,4,4,4); ApplyEffectToObject(DURATION_TYPE_TEMPORARY, eT, oTarget, fDuration);break;
        case 13: eT = EffectFrightened(); ApplyEffectToObject(DURATION_TYPE_TEMPORARY, eT, oTarget, fDuration);break;
        case 14: eT = EffectParalyze(); ApplyEffectToObject(DURATION_TYPE_TEMPORARY, eT, oTarget, fDuration);break;
        case 15: eT = EffectSilence(); ApplyEffectToObject(DURATION_TYPE_TEMPORARY, eT, oTarget, fDuration);break;
        case 16: eT = EffectSleep(); ApplyEffectToObject(DURATION_TYPE_TEMPORARY, eT, oTarget, fDuration);break;
        case 17: eT = EffectSlow(); ApplyEffectToObject(DURATION_TYPE_TEMPORARY, eT, oTarget, fDuration);break;
        case 18: eT = EffectKnockdown(); ApplyEffectToObject(DURATION_TYPE_TEMPORARY, eT, oTarget, fDuration); break;
        case 19: eI = EffectDamage( GetCurrentHitPoints(oTarget)-1, DAMAGE_TYPE_MAGICAL, DAMAGE_POWER_NORMAL);
        ...
        case 20: eA = EffectCutsceneDominated();ApplyEffectToObject(DURATION_TYPE_PERMANENT, eA, oTarget);break;
        case 21: eA = EffectCutsceneGhost(); ApplyEffectToObject(DURATION_TYPE_PERMANENT, eA, oTarget);break;
        case 22: eA = EffectCutsceneImmobilize(); ApplyEffectToObject(DURATION_TYPE_PERMANENT, eA, oTarget);break;
        case 23: eA = EffectCutsceneParalyze(); ApplyEffectToObject(DURATION_TYPE_PERMANENT, eA, oTarget);break;
        case 30: eEffect = GetFirstEffect(oTarget);
                 while (GetIsEffectValid(eEffect))
                 {
                    if (GetEffectType(eEffect) == EFFECT_TYPE_PETRIFY) RemoveEffect(oTarget, eEffect);
                    eEffect = GetNextEffect(oTarget);
                 } break;//Added July 5, 2003
        case 31: eEffect = GetFirstEffect(oTarget);
                 while (GetIsEffectValid(eEffect))
                 {
                    if (GetEffectType(eEffect) == EFFECT_TYPE_POISON) RemoveEffect(oTarget, eEffect);
                    eEffect = GetNextEffect(oTarget);
                 } break;
        case 32: eEffect = GetFirstEffect(oTarget);
                 while (GetIsEffectValid(eEffect))
                 {
                    if (GetEffectType(eEffect) == EFFECT_TYPE_DISEASE) RemoveEffect(oTarget, eEffect);
                    eEffect = GetNextEffect(oTarget);
                 } break;
        case 33: eEffect = GetFirstEffect(oTarget);
                 while (GetIsEffectValid(eEffect))
                 {
                    if (GetEffectType(eEffect) == EFFECT_TYPE_BLINDNESS) RemoveEffect(oTarget, eEffect);
                    eEffect = GetNextEffect(oTarget);
                 } break;
        case 34: eEffect = GetFirstEffect(oTarget);
                 while (GetIsEffectValid(eEffect))
                 {
                    if (GetEffectType(eEffect) == EFFECT_TYPE_CURSE) RemoveEffect(oTarget, eEffect);
                    eEffect = GetNextEffect(oTarget);
                 } break;
        case 35: eEffect = GetFirstEffect(oTarget);
                 while (GetIsEffectValid(eEffect))
                 {
                    if (GetEffectType(eEffect) == EFFECT_TYPE_FRIGHTENED) RemoveEffect(oTarget, eEffect);
                    eEffect = GetNextEffect(oTarget);
                 } break;
        case 36: eEffect = GetFirstEffect(oTarget);
                 while (GetIsEffectValid(eEffect))
                 {
                    if (GetEffectType(eEffect) == EFFECT_TYPE_STUNNED) RemoveEffect(oTarget, eEffect);
                    eEffect = GetNextEffect(oTarget);
                 } break;
        case 37: eEffect = GetFirstEffect(oTarget);
                 while (GetIsEffectValid(eEffect))
                 {
                    if (GetEffectType(eEffect) == EFFECT_TYPE_SILENCE) RemoveEffect(oTarget, eEffect);
                    eEffect = GetNextEffect(oTarget);
                 } break;
        case 38: eEffect = GetFirstEffect(oTarget);
                 while (GetIsEffectValid(eEffect))
                 {
                    RemoveEffect(oTarget, eEffect);
                    eEffect = GetNextEffect(oTarget);
                 } break;
        case 39: SetCommandable(TRUE, oTarget);
                 AssignCommand(oTarget, ClearAllActions()); break;
        case 40:SetCampaignFloat(sDMid, "dmfi_effectduration",fDMSetNumber,oMySpeaker);break;
