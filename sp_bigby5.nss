...
void main()
{
    ...
    */
    ...
    if(!GetIsReactionTypeFriendly(oTarget))
    {
        ...
        //SR
        if(!MyResistSpell(OBJECT_SELF, oTarget) &&(!MySavingThrow(SAVING_THROW_REFLEX,oTarget,GetSpellSaveDC()+GetThalieSpellDCBonus(OBJECT_SELF),SAVING_THROW_TYPE_SPELL) ))
        {
