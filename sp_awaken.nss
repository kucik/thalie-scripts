...
// End of Spell Cast Hook
    ...
    if(GetAssociate(ASSOCIATE_TYPE_ANIMALCOMPANION) == oTarget)
    {
        if(!GetHasSpellEffect(SPELL_AWAKEN))
        {
            ...
            effect eDex = EffectAbilityIncrease(ABILITY_DEXTERITY, eInt);
            effect eStr = EffectAbilityIncrease(ABILITY_STRENGTH, eInt);
            effect eCon = EffectAbilityIncrease(ABILITY_CONSTITUTION, eInt);
