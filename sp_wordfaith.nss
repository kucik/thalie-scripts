...
// End of Spell Cast Hook
        ...
        while (GetIsObjectValid(oTarget))
        {
            ...
            if (spellsIsTarget(oTarget, SPELL_TARGET_SELECTIVEHOSTILE, OBJECT_SELF))
            {
                ...
                //Make SR check
                if((!MyResistSpell(OBJECT_SELF, oTarget, fDelay)) &&(!MySavingThrow(SAVING_THROW_WILL,oTarget,GetSpellSaveDC()+GetThalieSpellDCBonus(OBJECT_SELF),SAVING_THROW_TYPE_DIVINE)))
                {
