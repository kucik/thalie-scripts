...
// End of Spell Cast Hook
    ...
    effect eAOE = EffectAreaOfEffect(AOE_PER_FOGFIRE,"sp_incclouda","sp_inccloudc","sp_inccloudb");
    ...
    ApplyEffectAtLocation(DURATION_TYPE_TEMPORARY, EffectAreaOfEffect(AOE_PER_DARKNESS,"****","****","****"), lTarget, RoundsToSeconds(nDuration));
}
